...
process_hsdecl buffer (HsTypeSig loc hsName hsQualType)= do 
		...
		process_hsQualType buffer hsQualType						
process_hsdecl _ _ =return ()

--
process_hsQualType::TextBuffer->HsQualType->IO()
process_hsQualType buffer (HsQualType _ hs_type)=process_hsType buffer hs_type

--
process_hsType::TextBuffer->HsType->IO()
process_hsType buffer(HsTyFun hstype1 hstype2)=do
					process_hsType buffer hstype1
					process_hsType buffer hstype2
process_hsType buffer (HsTyCon hsQName)=process_hsQName buffer hsQName
process_hsType buffer _ = return ()
--
process_hsQName:: TextBuffer->HsQName->IO()
process_hsQName buffer
